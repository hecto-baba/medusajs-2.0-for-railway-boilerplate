...
export class Migration20260911072003 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table if exists "vendor_admin" add constraint "vendor_admin_vendor_id_foreign" foreign key ("vendor_id") references "vendor" ("id") on update cascade on delete cascade;`);
  }
